...
namespace :standalone do
  ...
  task install: :build do
    ...
    FileUtils.mkdir_p "#{prefix}/bin/apple_scripts"
    FileUtils.cp 'lib/imessage/apple_scripts/send_attachment.applescript',
                 "#{prefix}/bin/apple_scripts/send_attachment.applescript"
    FileUtils.cp 'lib/imessage/apple_scripts/send_text.applescript', "#{prefix}/bin/apple_scripts/send_text.applescript"
  end
end
